...
//get property  by GEO Co-Ordinates V2 from AirBnB API takes neLat,neLng,swLat,swLng as parameters
export const getPropertiesByGeoCoordinates = async (neLat, neLng, swLat, swLng,source) => {
  try{
    const { data } = await axios.get(`https://airbnb19.p.rapidapi.com/api/v2/searchPropertyByGEO`, {
      params: {
        neLat: neLat,
        neLng: neLng,
        swLat: swLat,
        ...
        headers: {
          ...
          'X-RapidAPI-Key': import.meta.env.VITE_AIRBNB_API_KEY
          }
          }, { cancelToken: source.token })
